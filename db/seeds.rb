...
#インテリア・住まい・小物
interiors_child_array = ['キッチン/食器','ベッド/マットレス','ソファー/ソファーベッド','キッズ服（女の子）100cm〜','キッズ服（男の子）100cm〜','キッズ服（男女兼用）100cm〜','キッズ靴','子供用ファッション小物','おむつ/トイレ/バス','外出/移動用品','授乳/食事','ベビー家具/寝具/室内用品','おもちゃ','行事/記念日',]
#２階層目(子)のカテゴーを準備
