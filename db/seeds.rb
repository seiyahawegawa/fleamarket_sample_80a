...
#インテリア・住まい・小物
interiors_child_array = ['キッチン/食器','ベッド/マットレス','ソファー/ソファーベッド','椅子/チェア','机/テーブル','収納家具','ラグ/カーペット/マット','カーテン/ブラインド','ライト/照明','寝具','インテリア小物','季節/年中行事','その他',]
#２階層目(子)のカテゴーを準備
interiors_grandchild_array = [
  ...
  ['コタツ','ジャケット/上着','カウンターテーブル','サイドテーブル','センターテーブル','ダイニングテーブル','座卓/ちゃぶ台','アウトドア用','パソコン用','業務机/学習机','その他'],
  ['コート','ジャケット/上着','トップス（Tシャツ/カットソー）','トップス（トレーナー）','トップス（その他）','ボトムス','パジャマ','その他'],
  ['スニーカー','サンダル','長靴','その他',],
  ['靴下/スパッツ','帽子','エプロン','サスペンダー','タイツ','ハンカチ','バンダナ','ベルト','マフラー','傘','手袋','スタイ','バッグ','その他'],
  ['おむつ用品','おまる/補助便所','トレーニング/パンツ','ベビーバス','お風呂用品','その他'],
